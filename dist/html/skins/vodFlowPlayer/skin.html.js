...
window.SewisePlayerSkin.localSkin = 
	'<div class="sewise-player-ui">'+
		...
		'</div>'+
		'<div class="controlbar-clarity-window">'+
				'<div class="clarity-box">'+
				 '<div>'+
				    '<div class="clarity-Title">Definition Setting</div>'+
				    '<div class="clarity-Close"><a href="javascript:;" name="cancel_clarity">X</a></div>'+
				 '</div>'+
				 '<div class="clarity-radios-group">'+	
				 '</div> '+
				 '<div class="clarity-btns">'+
				    '<a class="clarity-btn-ok" href="javascript:;" name="confirm_clarity">OK</a>'+
				    '<a class="clarity-btn-cancel" href="javascript:;" name="cancel_clarity">Cancel</a>'+ 
				 '</div>'+
				'</div>'+
		'</div>'+
	'</div>';